package com.comunidadesvirtualesonline.cvo_notificacines.consumos;
            ...
            case 2:
                ...
                try {
                    ...
                    try {
                        ...
                        String JsonNotification = responsJson.toString();
                        Log.i(mensaje,"JsonNotification"+JsonNotification);



                        SharedPreferences pref = getSharedPreferences("MyPreferences", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = pref.edit();
                        editor.putString("JsonNotification",JsonNotification);
                        editor.commit();
